...
{
    public partial class PistonRightLeft : UserControl
    {
        public string titleText { get; set; }
        public string variableNameText { get; set; }

        string btnName;
        public PistonRightLeft()
        {
            InitializeComponent();
        }
        private void PistonUpDown_Load(object sender, EventArgs e)
        {
            ...
            Sensor_Piston_Gripper_Extend.Visible = false;
            Sensor_Piston_Gripper_Retract.Visible = false;
        }
